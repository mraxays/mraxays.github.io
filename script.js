 ...
 function createStars() {
  ...
  const pinned = ["clipxjs", "node-express-ejs-tailwindcss-starter", "dev-notes", "portfolio", "todoapp", "youtube-downloader"];
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    function erasePlaceholder() {
      ...
      const erasingInterval = setInterval(() => {
        searchInput.setAttribute("placeholder", searchInput.getAttribute("placeholder").substring(0, i - 1));
        i--;
        if (i === 0) {
    ...
    setInterval(() => {
      if (searchInput.getAttribute("placeholder") === placeholderTexts[currentIndex]) {
        erasePlaceholder();
      }
